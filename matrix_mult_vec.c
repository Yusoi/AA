...
//https://software.intel.com/en-us/articles/cdiag15344
#if !defined(IMP2) && !defined(IMP3)
int matrix_multiplication(float ** __restrict__ A, float ** __restrict__ B, float ** __restrict__ C)
{
